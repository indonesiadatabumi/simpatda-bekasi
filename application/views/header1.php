<?php 
	...
	if (($this->session->userdata('USER_JABATAN') == '99') || ($this->session->userdata('USER_JABATAN') == '98')) {
	...
	elseif ($this->session->userdata('USER_JABATAN') == "23") {
		$menus = array('pendaftaran' => 'Master WP', 'pendataan' => 'Pendataan', 'penagihan' => 'Penagihan', 'bkp' => 'Penerimaan', 'pelaporan' => 'Pembukuan');
   ...
   //Pemeriksaan
	...
	elseif ($this->session->userdata('USER_JABATAN') == "28") {
		$menus = array('pendaftaran' => 'Master WP','pendataan' => 'Pendataan','penagihan' => 'Penagihan',);
	...
	//Operator UPTD
		...
		$menus = array('pendaftaran' => 'Master WP', 'pendataan' => 'Pendataan', 'penetapan' => 'Penetapan',
						'bkp' => 'BKP', 'pembukuan' => 'Pembukuan', 'pemeliharaan' => 'Pemeliharaan');
