...
var completePage = function() {
	...
	$("#trigger_spt1").click(function() {
		if($("#spt_jenis_pajakretribusi").val() == "") {
			...
			showDialogStpd("penagihan/stpd_pelaporan/get_spt", 'List SPT', { 
...
var createEventToolbar = function() {
	$('#btn_save').click(function() {
		...
		var save_options = { 
			url : GLOBAL_MAIN_VARS["BASE_URL"] + "penagihan/stpd_pelaporan/insert",
			type : "POST",
			dataType: 'json',
	...
	$("#btn_view").click(function() {
		//load content panel
		load_content(GLOBAL_MAIN_VARS["BASE_URL"] + "penagihan/stpd_pelaporan/");
	});
};
