...
$(document).ready(function()
{
	...
	*/
	$("#grafik").attr('src', GLOBAL_MAIN_VARS["BASE_URL"] + "penagihan/kartu_data_wp/deskripsi?spt_periode="+$("#spt_periode").val()+"&spt_periode2="+$("#spt_periode2").val()+"&wp_id="+$("input[name=wp_id]").val());
