...
var createDataGrid = function (){
	$("#stpd_table").flexigrid({
		...
		colModel : [
			...
			{display: 'Tanggal Lapor', name : 'stpd_tgl_setoran', width : 80, sortable : true, align: 'center', process: cellClick},
...
var editData = function(stpd_id) {
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		load_content(GLOBAL_MAIN_VARS["BASE_URL"] + "penagihan/stpd_pelaporan/add");
 	});
