...
var completePage = function() {
	$('#btn_npwpd_teguran_laporan').click(function() {
		let jenis_pajak = $('#spt_jenis_pajakretribusi').val()
		let bulan = $('#masa_pajak').val()
		let tahun = $('#tahun').val()
		showDialog("wajib_pajak/popup_npwpd_teguran_laporan?jenis_pajak="+jenis_pajak+"&bulan="+bulan+"&tahun="+tahun, 'Nomor Pokok Wajib Pajak/Retribusi', 1000, 500);
	});
