...
var createDataGrid = function() {
	$("#popup_stpd_pelaporan_table").flexigrid({
		...
		colModel : [
			...
			{display: 'Tgl. Lapor', name : 'setorpajret_tgl_bayar', width : 60, sortable : true, align: 'left'},
...
var chosenSPT = function(spt_nomor, setorpajret_id) {
	...
	$.post(GLOBAL_MAIN_VARS['BASE_URL'] + "penagihan/stpd_pelaporan/get_detail_setoran", {setorpajret_id : setorpajret_id},
		function(data) {
