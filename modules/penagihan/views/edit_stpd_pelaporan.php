<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-penetapan">
			Rekam STPD Berdasarkan Pelaporan: <small><small id='title_head'>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
					...
					<td valign="top" class="outsets">
						<table class="admintable">
							...
							<tr>
								...
								<td>
									<input type="text" name="periode" id="periode" class="inputbox mandatory" size="4" maxlength="4" value="<?= $row->stpd_periode;?>" />
								</td>
							</tr>							
							<tr>
