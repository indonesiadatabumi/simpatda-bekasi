...
<script type="text/javascript">
	...
	GLOBAL_STPD_VARS["get_list"] = "<?=base_url();?>penagihan/stpd_pelaporan/get_list";
	GLOBAL_STPD_VARS["add_stpd"] = "penagihan/stpd_pelaporan/add";
	GLOBAL_STPD_VARS["edit_stpd"] = "penagihan/stpd_pelaporan/edit";
	GLOBAL_STPD_VARS["delete_stpd"] = "<?=base_url();?>penagihan/stpd_pelaporan/delete";
</script>
<script type="text/javascript" src="modules/penagihan/scripts/view_stpd_pelaporan.js"></script>