		...
		<form name="frm_daftar_kartu_data" id="frm_daftar_kartu_data">
			<table class="admintable">
				<tr>
					...
					<td>									
						<?php
							$attributes = 'id="spt_jenis_pajakretribusi" class="inputbox mandatory jenis_pajak"';
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" name="wp_wr_camat" id="wp_wr_camat">
...
<script type="text/javascript" src="modules/penagihan/scripts/surat_teguran.js"></script>