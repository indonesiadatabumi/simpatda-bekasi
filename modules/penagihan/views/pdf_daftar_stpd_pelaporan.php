...
$jdl[0]['TEXT'] = "";
$jdl[0]['T_ALIGN'] = 'L';
$jdl[1]['TEXT'] = "<h1>DAFTAR PENERBITAN SURAT TAGIHAN PAJAK DAERAH (STPD) PELAPORAN " . strtoupper($jenis_pajak)."</h1>";
$pdf->tbDrawData($jdl);

$jdl[0]['TEXT'] = "";
$jdl[1]['TEXT'] = "<h1>SANKSI PELAPORAN REALISASI ".strtoupper(getNamaBulan($_GET['bulan']))." ".$_GET['tahun']."</h1>";
$pdf->tbDrawData($jdl);
...
$header1[4]['TEXT'] = "<b>ALAMAT</b>";
if ($_GET['jenis_pajak'] != '4')
	$header1[5]['TEXT'] = "<b>NPWPD</b>";
else 
	$header1[4]['COLSPAN'] = 2;
$header1[6]['TEXT'] = "<b>MASA PAJAK</b>";
$header1[7]['TEXT'] = "<b>TANGGAL PELAPORAN</b>";
$header1[8]['TEXT'] = "<b>SANKSI ADMINISTRASI</b>";
$header1[9]['TEXT'] = "<b>KET.</b>";

$header1[1]['COLSPAN'] = 2;
$header1[0]['ROWSPAN'] = 2;$header1[3]['ROWSPAN'] = 2;$header1[4]['ROWSPAN'] = 2;$header1[5]['ROWSPAN'] = 2;$header1[6]['ROWSPAN'] = 2;$header1[7]['ROWSPAN'] = 2;$header1[8]['ROWSPAN'] = 2;$header1[9]['ROWSPAN'] = 2;
...
$header1[6]['BRD_TYPE'] = 'LT';$header1[7]['BRD_TYPE'] = 'LT';$header1[8]['BRD_TYPE'] = 'LT';$header1[9]['BRD_TYPE'] = 'LRT';

$header2[1]['TEXT'] = "<b>NOMOR</b>";
$header2[2]['TEXT'] = "<b>TANGGAL</b>";

$header2[1]['COLSPAN'] = 1;
$header2[1]['BRD_TYPE'] = 'LT';$header2[6]['BRD_TYPE'] = 'LT';$header2[8]['BRD_TYPE'] = 'LT';
$header2[2]['BRD_TYPE'] = 'LRT';$header2[7]['BRD_TYPE'] = 'LRT';
...
$header3[5]['BRD_TYPE'] = 'LT';$header3[6]['BRD_TYPE'] = 'LT';$header3[7]['BRD_TYPE'] = 'LT';$header3[8]['BRD_TYPE'] = 'LT';$header3[9]['BRD_TYPE'] = 'LRT';
...
$tbl2[7]['T_ALIGN'] = 'C';$tbl2[8]['T_ALIGN'] = 'R';$tbl2[9]['T_ALIGN'] = 'C';
...
if (count($query) > 0) {		
	foreach($query as $key => $val) {
		...
		$tbl2[6]['TEXT'] = getNamaBulan($arr_masa_pajak[1])." ".$arr_masa_pajak[0];
		$tbl2[7]['TEXT'] = format_tgl($val['stpd_tgl_setoran']);
		$tbl2[8]['TEXT'] = number_format($val['stpd_pajak'],0,",",".");
		$tbl2[9]['TEXT'] = "";
		$pdf->tbDrawData($tbl2);
...
$tbl3[8]['TEXT'] = number_format($pajak,0,",",".");
$tbl3[9]['TEXT'] = "";
...
$tbl3[8]['T_ALIGN'] = 'R';
$tbl3[0]['COLSPAN'] = 8;
$tbl3[0]['BRD_TYPE'] = 'LT';$tbl3[7]['BRD_TYPE'] = 'LT';$tbl3[8]['BRD_TYPE'] = 'LT';$tbl3[9]['BRD_TYPE'] = 'LRT';
$pdf->tbDrawData($tbl3);
