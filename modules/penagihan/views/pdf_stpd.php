...
if (!empty($arr_data)) {
	foreach ($arr_data as $key => $val) {
		...
		$dt[0]['BRD_TYPE'] = 'L';
		$dt[1]['TEXT'] = "I.";
		$dt[2]['TEXT'] = "Berdasarkan Pasal 158 Peraturan Daerah Kota Bekasi No. 1 Tahun 2024 telah dilakukan penelitian dan atau pemeriksaan ";
		$dt[2]['COLSPAN'] = 6;
		$dt[8]['TEXT'] = "";
		$dt[8]['BRD_TYPE'] = 'R';		
		$pdf->tbDrawData($dt);
		...
		if ($val['sanksi_lapor'] == '1') {
			$dt2[0]['TEXT'] = "";
			$dt2[0]['BRD_TYPE'] = 'L';
			$dt2[1]['TEXT'] = "";
			$dt2[2]['TEXT'] = "";
			$dt2[3]['TEXT'] = "a. Sanksi (Psl. 158 ayat (5))    =   ".number_format($val['stpd_sanksi'], 0,",",".");
		}else {
			$dt2[0]['TEXT'] = "";
			$dt2[0]['BRD_TYPE'] = 'L';
			$dt2[1]['TEXT'] = "";
			$dt2[2]['TEXT'] = "";
			$dt2[3]['TEXT'] = "a. Bunga (Psl. 158 ayat (3))    =   ".
		...
		$ket[0]['TEXT'] = "1.";$ket[1]['TEXT'] = "Harap penyetoran dilakukan melalui (".$pemda->dapemda_bank_nama.") .";
