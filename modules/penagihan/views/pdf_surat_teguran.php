...
if (!empty($ar_wp)) {
	...
	foreach ($ar_wp as $k => $v) {		
		...
		if (substr($v['npwprd'],2,-17) == '1') {
			$tbd[2]['TEXT'] = "        Yth. PEMILIK "; 
		}else{
			$tbd[2]['TEXT'] = "        Yth. PIMPINAN  "; 
		}
		...
		$tbd[0]['TEXT'] = "";
		$tbd[1]['TEXT'] = "";
		$tbd[2]['TEXT'] = "        ".strtoupper($v['wp_wr_nama']);
		$tbd[2]['T_SIZE'] = 6.5;
		$tbd[2]['T_ALIGN'] = "L";
		$tbd[3]['TEXT'] = "";
		$pdf->tbDrawData($tbd);
		...
		*/
		...
		$new_line = "\n\n";
			...
			foreach ($detail as $key => $val) {
				...
				$jatuh_tempo = date('Y-m-10', strtotime($tanggal)); 
		...
		$dg[1]['T_SIZE'] = 9;
		$dg[2]['TEXT'] = "( ". ucwords(strtolower(terbilang($total_pajak). " Rupiah"))." )"; $dg[2]['T_SIZE'] = 9;
		$dg[3]['TEXT'] = "";
		...
		$dt[0]['TEXT'] = "";
		$dt[1]['TEXT'] = "Demikian agar maklum, atas perhatiannya diucapkan terima kasih.\n\n\n";
		$dt[1]['T_SIZE'] = 9;
		$dt[1]['COLSPAN'] = 2;$dt[1]['LN_SIZE'] = 4;
		$dt[3]['TEXT'] = "";
		$dt[1]['BRD_TYPE'] = '0';$dt[2]['BRD_TYPE'] = '';
		...
		$dt[0]['TEXT'] = "";$dt[1]['TEXT'] = "    ";
		$dt[2]['TEXT'] = "";$dt[3]['TEXT'] = "BEKASI, ".strtoupper(format_tgl($_GET['tgl_cetak'],false,true));
		...
		$dt[2]['TEXT'] = "";$dt[3]['TEXT'] =  $dt[3]['TEXT'] = $pejabat->ref_japeda_nama."\n"; //$dt[3]['TEXT'] .= "Sekretaris";
		//$dt[2]['TEXT'] = "";$dt[3]['TEXT'] =  $dt[3]['TEXT'] ="Plh. Kepala Badan Pendapatan Daerah"."\n"; $dt[3]['TEXT'] .= "        Sekretaris";
		...
		$dt[0]['TEXT'] = "";$dt[1]['TEXT'] = " ";
		$dt[2]['TEXT'] = "  ";$dt[3]['TEXT'] = " ".$pejabat->pejda_nama;
