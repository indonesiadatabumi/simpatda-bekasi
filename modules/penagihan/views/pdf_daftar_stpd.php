...
$jdl[0]['TEXT'] = "";
$jdl[0]['T_ALIGN'] = 'L';
$jdl[1]['TEXT'] = "<h1>DAFTAR PENERBITAN SURAT TAGIHAN PAJAK DAERAH (STPD) " . strtoupper($jenis_pajak)."</h1>";
$pdf->tbDrawData($jdl);

$jdl[0]['TEXT'] = "";
$jdl[1]['TEXT'] = "<h1>SANKSI PEMBAYARAN REALISASI ".strtoupper(getNamaBulan($_GET['bulan']))." ".$_GET['tahun']."</h1>";
$pdf->tbDrawData($jdl);
...
$header1[7]['TEXT'] = "<b>TANGGAL PEMBAYARAN</b>";
