...
$jdl[0]['T_ALIGN'] = 'L';
$jdl[1]['TEXT'] = "<h1>PENERBITAN SURAT TAGIHAN PAJAK DAERAH (STPD) PELAPORAN " . strtoupper($jenis_pajak)."</h1>";
$pdf->tbDrawData($jdl);

$jdl[0]['TEXT'] = "";
$jdl[1]['TEXT'] = "<h1>BERDASARKAN Tanggal Penetapan ".$_GET['tgl_penetapan1']." s/d ".$_GET['tgl_penetapan2']."</h1>";
$pdf->tbDrawData($jdl);
