...
var createDataGrid = function (){
	$("#pajak_parkir_table").flexigrid({
		url: GLOBAL_PAJAK_PARKIR_VARS["get_list"],
		dataType: 'json',
		colModel : [
...
var editData = function(spt_id, spt_jenis_pajakretribusi) {
	showDialogPost(GLOBAL_PAJAK_PARKIR_VARS["edit_sptpd"], "Pajak Parkir", {
				'spt_id' : spt_id,
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PAJAK_PARKIR_VARS["add_sptpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_MAIN_VARS["BASE_URL"] + "pendataan/pajak_parkir/delete",
