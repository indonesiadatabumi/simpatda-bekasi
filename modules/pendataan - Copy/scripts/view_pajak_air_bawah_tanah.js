...
var createDataGrid = function (){
	$("#pajak_air_table").flexigrid({
		url: GLOBAL_PAJAK_AIR_VARS["get_list"],
		dataType: 'json',
		colModel : [
		...
		sortorder: "desc",
		usepager: true,
		title: 'DAFTAR SPT AIR BAWAH TANAH',
		useRp: true,
		rp: 10,
...
var editData = function(spt_id, spt_jenis_pajakretribusi) {
	showDialogPost(GLOBAL_PAJAK_AIR_VARS["edit_sptpd"], "Pajak Air Tanah", {
				'spt_id' : spt_id,
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PAJAK_AIR_VARS["add_sptpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_MAIN_VARS["BASE_URL"] + "pendataan/pajak_air_bawah_tanah/delete",
		     data: "mode=delete&id="+selectedItems,
		     success: function(msg){
	 			$("#pajak_air_table").flexReload();
