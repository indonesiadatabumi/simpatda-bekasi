...
$(document).ready(function() {	
	...
	$('#wp_wr_kd_camat').chainSelect('#lurah_id', GLOBAL_MAIN_VARS["LIST_KELURAHAN"],
	{
	});

	$('#ddl_camat').chainSelect('#lurah_id2', GLOBAL_MAIN_VARS["LIST_KELURAHAN"],
	{
	});
	...
	$("#btn_cetak").click(function() {
		if (validateForm()) {
			...
			lurah = ($("#lurah_id").val()!==undefined ? $("#lurah_id").val() : "0");
	...
	$("#btn_cetak_excel").click(function() {
		if (validateForm()) {
			...
			$.download(url, 'filename=daftar_tayang_reklame&format=xls');
			return false;
		}
	});
	...
	$("#btn_cetak2").click(function() {
		if ($("#ddl_jenis_pajak").val() == "0") {
			...
			lurah = ($("#lurah_id2").val()!==undefined ? $("#lurah_id2").val() : "0");
