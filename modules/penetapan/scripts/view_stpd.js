...
var createDataGrid = function (){
	$("#stpd_table").flexigrid({
		url: GLOBAL_PENETAPAN_STPD_VARS["get_list"],
		dataType: 'json',
		colModel : [
		...
		sortorder: "DESC",
		usepager: true,
		title: 'DAFTAR PENETAPAN STPD / STRD',
		useRp: true,
		rp: 10,
...
var selectRow = function(index, id) {
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PENETAPAN_STPD_VARS["add_stpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_PENETAPAN_STPD_VARS["delete_stpd"],
