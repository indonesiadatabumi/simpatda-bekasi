<div id="toolbar-box">
	...
	<div class="m">
		<div class="header icon-48-print">
			CETAK DAFTAR HABIS TAYANG REKLAME
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
				...
				<div>
					<table class="admintable">
						<tr>
							...
							<td>			
								<input type="hidden" name="spt_jenis_pajakretribusi" id="spt_jenis_pajakretribusi" value="4"/>						
								<input type="text" class="inputbox" size="11" value="Pajak Reklame" tabindex="3" readonly/>
							</td>
						</tr>
						<tr>
				...
				<div>
					<table class="admintable">
						<tr>
							...
							<td>									
								<input type="hidden" name="ddl_jenis_pajak" id="ddl_jenis_pajak" value="4"/>						
								<input type="text" class="inputbox" size="11" value="Pajak Reklame" tabindex="3" readonly/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<?php
									$attributes = 'id="lurah_id2" name="lurah_id"';
									echo form_dropdown('lurah_id', $kelurahan, '', $attributes);
								?>
							</td>
						</tr>
...
<script type="text/javascript">
	...
	GLOBAL_DAFTAR_SURAT_KETETAPAN_VARS["cetak"] = "<?=base_url();?>penetapan/daftar_jam_tayang/pdf_daftar_jam_tayang";
	GLOBAL_DAFTAR_SURAT_KETETAPAN_VARS["cetak_excel"] = "<?=base_url();?>penetapan/daftar_jam_tayang/xls_daftar_jam_tayang";
	GLOBAL_DAFTAR_SURAT_KETETAPAN_VARS["cetak_via_tanggal"] = "<?=base_url();?>penetapan/daftar_jam_tayang/pdf_daftar_jam_tayang_via_tanggal";
	GLOBAL_DAFTAR_SURAT_KETETAPAN_VARS["cetak_excel_via_tanggal"] = "<?=base_url();?>penetapan/daftar_jam_tayang/xls_daftar_jam_tayang_via_tanggal";
</script>
<script type="text/javascript" src="modules/penetapan/scripts/form_daftar_jam_tayang.js"></script>