...
if (!empty($data_id)) {	
	foreach ($data_id as $k => $v) {		
		...
		$header_type1[5]['TEXT'] = "No. Urut\n".format_angka($this->config->item('length_kohir_spt'), $data[0]['lhp_no_periksa']);
		...
		$tbd[2]['TEXT'] = ":";
		$tbd[3]['TEXT'] = "".$data[0]['lhp_kode_billing'];
		$pdf->tbDrawData($tbd);
		...
		$dt[0]['BRD_TYPE'] = 'L';
		$dt[1]['TEXT'] = "I.";
		$dt[2]['TEXT'] = "Berdasarkan Pasal 128 Peraturan Daerah Kota Bekasi No. 01 Tahun 2024 telah dilakukan pemeriksaan atau keterangan lain atas";
		$dt[2]['COLSPAN'] = 6;
		$dt[8]['TEXT'] = "";
		$dt[8]['BRD_TYPE'] = 'R';		
		$pdf->tbDrawData($dt);
		...
		$dt2[1]['TEXT'] = "";
		$dt2[2]['TEXT'] = "";
		$dt2[3]['TEXT'] = "b. Kenaikan (Psl. 158(11))";
		$dt2[4]['TEXT'] = "Rp.";
		$dt2[4]['T_ALIGN'] = 'R';
		...
		$ket[0]['TEXT'] = "2.";
		$ket[1]['TEXT'] = "Apabila ".$s_title." ini tidak atau Kurang Dibayar setelah lewat waktu paling lama 30 hari  sejak  ".$s_title." ini ditetapkan dikenakan sanksi administrasi berupa bunga sebesar 0.6 %  per bulan.\n\n";
		$pdf->tbDrawData($ket);
		...
		$dt2[0]['TEXT'] = "";
		$dt2[0]['BRD_TYPE'] = 'L';
		$dt2[1]['TEXT'] = "Kode Billing";
		$dt2[2]['TEXT'] = ":";
		$dt2[3]['TEXT'] = $data[0]['lhp_kode_billing'];
		$dt2[4]['TEXT'] = "";
		$dt2[5]['TEXT'] = "";
		$dt2[5]['BRD_TYPE'] = 'R';		
		$pdf->tbDrawData($dt2);
