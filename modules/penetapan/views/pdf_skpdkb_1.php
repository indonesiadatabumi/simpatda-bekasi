...
if (!empty($data_id)) {	
	foreach ($data_id as $k => $v) {		
		...
		$ket[0]['TEXT'] = "1.";$ket[1]['TEXT'] = "Harap penyetoran dilakukan melalui Bendahara Penerimaan atau Kas Daerah dengan menggunakan Surat Setoran Pajak Daerah (SSPD).";
		...
		$dt[0]['T_ALIGN'] = 'L';
		$dt[0]['COLSPAN'] = 7;$dt[0]['LN_SIZE'] = 2;
		$pdf->tbDrawData($dt);
		
		$dt[0]['TEXT'] = "<i>..................................................................Gunting disini..........................................................</i>";	
		$dt[0]['COLSPAN'] = 7;$dt[0]['T_ALIGN'] = 'C';$dt[0]['LN_SIZE'] = 3;
		$pdf->tbDrawData($dt);
		...
		$dt[0]['TEXT'] = "MODEL : DPD - 10D";
		$dt[0]['BRD_TYPE'] = 'T';$dt[0]['T_SIZE'] = 8;
		$dt[0]['T_ALIGN'] = 'L';$dt[0]['LN_SIZE'] = 3.5;
		$dt[0]['COLSPAN'] = 6;
		$pdf->tbDrawData($dt);
