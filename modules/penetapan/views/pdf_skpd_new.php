...
if (!empty($arr_data)) {
	foreach ($arr_data as $k1 => $v1) {
		...
		$tbd[3]['TEXT'] = "".$data_skpd[0]['wp_wr_almt'];
		$tbd[1]['V_ALIGN'] = 'T';
		$tbd[2]['V_ALIGN'] = 'T';
		$pdf->tbDrawData($tbd);
		...
		$tc[0]['WIDTH'] = 5;$tc[1]['WIDTH'] = 8;$tc[2]['WIDTH'] = 37;$tc[3]['WIDTH'] = 50;$tc[4]['WIDTH'] = 35;$tc[5]['WIDTH'] = 50;$tc[6]['WIDTH'] = 5;
		...
		//Table Header
		$th[0]['TEXT'] = "";$th[1]['TEXT'] = "No.";$th[2]['TEXT'] = "Perhitungan";$th[3]['TEXT'] = "Jumlah (Rp)";$th[4]['TEXT'] = "Naskah Reklame";$th[5]['TEXT'] = "Lokasi Pasang";$th[6]['TEXT'] = "";
		$th[0]['BRD_TYPE'] = 'L';$th[1]['BRD_TYPE'] = 'LT';$th[2]['BRD_TYPE'] = 'LT';$th[3]['BRD_TYPE'] = 'LT';$th[4]['BRD_TYPE'] = 'LT';$th[5]['BRD_TYPE'] = 'LT';$th[6]['BRD_TYPE'] = 'LR';
		$pdf->tbDrawData($th);
		...
		if (count($_data_skpd) > 1) {
			...
			foreach ($_data_skpd as $key => $value) {
				if ($_data_skpd[0]['spt_jenis_pajakretribusi'] == '4' || $_data_skpd[0]['spt_jenis_pajakretribusi'] == '8') {
					...
					$td[4]['TEXT'] = format_currency($value['spt_pajak']);
					$td[5]['TEXT'] = format_currency($value['spt_pajak']);
					$td[6]['TEXT'] = "";
		...
		$tx[0]['TEXT'] = "";$tx[1]['TEXT'] = "";$tx[6]['TEXT'] = "";
		$tx[1]['COLSPAN'] = 4;
		$tx[0]['BRD_TYPE'] = 'L';$tx[1]['BRD_TYPE'] = 'T';$tx[6]['BRD_TYPE'] = 'R';
		$tx[0]['LN_SIZE'] = 2;$tx[1]['LN_SIZE'] = 2;$tx[6]['LN_SIZE'] = 2;
		$pdf->tbDrawData($tx);
		...
		$ket[0]['TEXT'] = "2.";$ket[1]['TEXT'] = "Apabila ".$s_title." ini tidak atau Kurang Dibayar setelah lewat waktu paling lama 30 hari  sejak  ".$s_title." ini ditetapkan dikenakan sanksi administrasi berupa bunga sebesar 1%  per bulan.\n";
		$pdf->tbDrawData($ket);
