...
////Table Base Classs
require_once APPPATH.'libraries/fpdf/table/class.fpdf_table_reklame.php';
...
if (!empty($arr_data)) {
	foreach ($arr_data as $k1 => $v1) {
		...
		$pdf->tbDrawData($tbd);
/**
		$lama_pasang = "+".$_data_skpd[0]['sptrek_lama_pasang']."days";
		$batas_tayang = date('d-m-Y', strtotime($_data_skpd[0]['netpajrek_tgl'] . $lama_pasang));

		$tbd[0]['TEXT'] = "";
		$tbd[1]['TEXT'] = "Batas Akhir Tayang : ". format_tgl($batas_tayang,false,true);
		$tbd[1]['COLSPAN'] = 4;
		$tbd[3]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($tbd);
*/
