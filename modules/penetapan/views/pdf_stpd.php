...
if (!empty($arr_data)) {
	foreach ($arr_data as $k => $v) {
		...
		//prepare data
		$data = $model->call_v_nota_perhitungan($v['spt_id']);
		...
		$artgl = explode("-",$data[0]['spt_periode_jual1']);
		$blnxa = $artgl[1];
		$tahun_pajak = $artgl[0];
		...
		$wp_wr_lurah = ($data[0]['wp_wr_lurah'] == "") ? "" : "KEL. ".$data[0]['wp_wr_lurah'];
		$wp_wr_camat = ($data[0]['wp_wr_camat'] == "") ? "" : "KEC. ".$data[0]['wp_wr_camat'];
		
		$tbd[0]['TEXT'] = "";
		$tbd[1]['TEXT'] = "Alamat";
		$tbd[2]['TEXT'] = ":";
		$tbd[3]['TEXT'] = "".strtoupper(ereg_replace("\r|\n","",$data[0][wp_wr_almt]))." ".strtoupper($wp_wr_lurah." ".$wp_wr_camat);
		$pdf->tbDrawData($tbd);
		...
		$dt[0]['TEXT'] = "";$dt[0]['BRD_TYPE'] = 'L';
		$dt[1]['TEXT'] = "";
		$dt[2]['TEXT'] = "Kode Rekening	:   ".$data[0]['korek'];
		$dt[2]['COLSPAN'] = 6;
		$dt[8]['TEXT'] = "";$dt[8]['BRD_TYPE'] = 'R';		
		$pdf->tbDrawData($dt);
		...
		$dt[0]['TEXT'] = "";$dt[0]['BRD_TYPE'] = 'L';
		$dt[1]['TEXT'] = "";
		$dt[2]['TEXT'] = "Nama Pajak	     :   ".$data[0]['jenis_pajak'];
		$dt[2]['COLSPAN'] = 6;
		...
		$dt2[6]['TEXT'] = "Rp.";
		$dt2[6]['T_ALIGN'] = 'R';
		$dt2[7]['TEXT'] = format_currency($data[0]['spt_pajak']);
		$dt2[7]['T_ALIGN'] = 'R';
		...
		$dt2[1]['TEXT'] = "";
		$dt2[2]['TEXT'] = "";
		$dt2[3]['TEXT'] = "a. Bunga (Psl. 100 ayat (3))";
		$dt2[4]['TEXT'] = "";
		$dt2[5]['TEXT'] = "";
		$dt2[6]['TEXT'] = "Rp.";$dt2[6]['T_ALIGN'] = 'R';
		$dt2[7]['TEXT'] = format_currency($total_bunga);
		$dt2[5]['T_ALIGN'] = 'R';
		$dt2[8]['TEXT'] = "";$dt2[8]['BRD_TYPE'] = 'R';
		$pdf->tbDrawData($dt2);
		
		$total_pajak = $data[0]['spt_pajak'] + $total_bunga;
		...
		$dt4[7]['TEXT'] = format_currency($total_pajak);$dt4[7]['T_ALIGN'] = 'R';$dt4[7]['BRD_TYPE'] = 'T';
		...
		$tnd[1]['TEXT'] = "<nu>  ".strtoupper($mengetahui->pejda_nama)."  </nu>";
		$pdf->tbDrawData($tnd);
