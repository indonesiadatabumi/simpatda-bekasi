...
$arrbulan = array(1=>'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
 ...
 // HTTP headers
HeaderingExcel('daftar_ketetapan_via_tgl_reklame.xls');
...
$worksheet1->write_string($no_baris,11, "JATUH TEMPO", $fheader);
...
if (!empty($data)) {
	foreach($data as $key => $val) {
		...
		$worksheet1->write_number($no_baris,11, ceil((strtotime($val['netapajrek_tgl_jatuh_tempo']) + $ut_to_ed_diff) / $seconds_in_a_day),$fdate);
