...
if (!empty($data_id)) {
	foreach ($data_id as $k => $v) {
		...
		$spacer1[0]['WIDTH'] = 15;$spacer1[1]['WIDTH'] = 55;$spacer1[2]['WIDTH'] = 5;$spacer1[3]['WIDTH'] = 85;$spacer1[4]['WIDTH'] = 5;$spacer1[5]['WIDTH'] = 25;
		...
		$dt[0]['TEXT'] = "MODEL : DPD - 10E";$dt[0]['T_SIZE'] = 8;
		$dt[0]['T_ALIGN'] = 'L';
		$dt[0]['COLSPAN'] = 7;
		$pdf->tbDrawData($dt);
		...
		$dt2[0]['TEXT'] = "MODEL : DPD - 10E";
		$dt2[0]['BRD_TYPE'] = 'T';$dt2[0]['T_SIZE'] = 8;
		$dt2[0]['T_ALIGN'] = 'L';
		$dt2[0]['COLSPAN'] = 6;
		$pdf->tbDrawData($dt2);
