		...
		if ($_GET['jenis_pajak'] != "4") {
					...
					if ($type_cetak == 1) {
						...
						if ($_GET['status_spt'] == "8") {
							foreach ($dt_rekap as $row) {
								...
								if ($lap_realisasi != 1) {
									if ($cek_bayar)
										$worksheet1->write_number($no_baris, 13, $cek_bayar->setorpajret_jlh_bayar, $fcurrency);
									else
			...
			if($this->input->get('camat_id') != ""){
				...
				foreach ($dt_rekap as $row) {
					...
					if ($lap_realisasi != 1) {
						if ($cek_bayar->skbh_tgl != NULL)
							$worksheet1->write_number($no_baris, 16, $cek_bayar->setorpajret_jlh_bayar, $fcurrency);
						else
