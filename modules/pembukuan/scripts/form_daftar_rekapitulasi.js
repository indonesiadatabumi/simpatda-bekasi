...
var onLoad = function() {
	...
	$('#camat_id').chainSelect('#lurah_id', GLOBAL_MAIN_VARS["LIST_KELURAHAN"],
	{
	});

	//Data Type Combo (Category - Sub Category - Sub Sub Category)
	$('#camat_id_realisasi').chainSelect('#lurah_id_realisasi', GLOBAL_MAIN_VARS["LIST_KELURAHAN"],
	{
	});

	//Data Type Combo (Category - Sub Category - Sub Sub Category)
	$('#camat_id_pendataan').chainSelect('#lurah_id_pendataan', GLOBAL_MAIN_VARS["LIST_KELURAHAN"],
	{
	});
};
...
var createEventToolbar = function() {
	...
	$("input[name=cetak_realisasi]").click(function() {
		...
		$.download(GLOBAL_MAIN_VARS["BASE_URL"] + "pembukuan/daftar_rekapitulasi/cetak" + 
			...
			//"&jenis_restoran=" + $("select[name=jenis_restoran_realisasi]").val() +
				...
				"&lurah_id=" + $("#lurah_id_realisasi").val(),
	...
	$("input[name=cetak_pendataan]").click(function() {
		...
		$.download(GLOBAL_MAIN_VARS["BASE_URL"] + "pembukuan/daftar_rekapitulasi/cetak_tgl_pendataan" + 
				...
				"&lurah_id=" + $("#lurah_id_pendataan").val(),
