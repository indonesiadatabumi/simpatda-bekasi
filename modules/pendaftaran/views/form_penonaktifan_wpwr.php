				...
				<tr>
					...
					<td class="button" id="toolbar-ref">
						<a href="#" id="btn_view" class="toolbar">
							<span class="icon-32-ref" title="Lihat Data"></span>Lihat WP Non Aktif
						</a>
					</td>
				</tr>
			</table>
...
<div id="element-box">
	...
	<div class="m">
		<!-- content body -->
		<form method="post" name="frm_penonaktifan_wp" id="frm_penonaktifan_wp">
		...
		<table class="admintable">
			<tr>
				...
				<td>
					<input type="text" name="tgl_nonaktif" id="f_date_nonaktif" size="10" class="mandatory" tabindex="1" value="" />
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
	var GLOBAL_NONAKTIF_WP_WR_VARS = new Array ();
	GLOBAL_NONAKTIF_WP_WR_VARS["add_wpwr_nonaktif"] = "<?=base_url();?>pendaftaran/penonaktifan_wpwr/add";
</script>
<script type="text/javascript" src="modules/pendaftaran/scripts/form_penonaktifan_wpwr.js"></script>