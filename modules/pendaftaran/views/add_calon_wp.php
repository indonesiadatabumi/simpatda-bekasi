<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-pendaftaran_bu">
			Form Pendaftaran Calon WP: <small><small id='title_head'>[ Baru ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		<form method="post" name="frm_add_calon_wp" id="frm_add_calon_wp" >
							...
							<td valign="top" class="outsets">
								<table class="admintable" border=0 cellspacing="1">
									<tr>
										...
										<td>
											<input type="text" size="9" maxlength="7" class="mandatory" id="wp_wr_no_urut" name="wp_wr_no_urut" readonly  />
									...
									<tr>
										<td class="key">NIB</td>
										<td>
											<input type="text" name="wp_wr_nib" id="wp_wr_nib" class="inputbox" size="40" />
										</td>
									</tr>
									<tr>
										<td class="key">NPWP Perusahaan</td>
										<td>
											<input type="text" name="wp_wr_npwp_perusahaan" id="wp_wr_npwp_perusahaan" class="inputbox" size="40" />
										</td>
									</tr>
								</table>
							</td>
							<td valign="top" class="outsets">
								<table class="admintable" border=0 cellspacing="1">
									<tr>
										...
										<td>
											<input type="text" style="text-transform: uppercase;" name="wp_wr_nama_milik" id="wp_wr_nama_milik" class="inputbox mandatory" size="40" />
										</td>
									</tr>
									<tr>
										<td class="key_small" valign="top"><label for="username">Alamat</label></td>
										<td>
											<textarea style="text-transform: uppercase;" cols="30" rows="2" name="wp_wr_almt_milik" id="wp_wr_almt_milik" class="inputbox mandatory"></textarea>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="key">NIK</td>
										<td>
											<input type="text" name="wp_wr_nik" id="wp_wr_nik" class="inputbox mandatory" size="40" />
										</td>
									</tr>
									<tr>
										<td class="key">NPWP Pemilik</td>
										<td>
											<input type="text" name="wp_wr_npwp_pemilik" id="wp_wr_npwp_pemilik" class="inputbox" size="40" />
										</td>
									</tr>
									<tr>
										<td class="key">Omset Per Bulan</td>
										<td>
											<input type="text" name="omset" id="omset" class="inputbox" size="11" />
										</td>
									</tr>
								</table>
							</td>
...
<script type="text/javascript">
	...
	GLOBAL_CALON_WP_VARS["save_calon_wp"] = "<?= base_url();?>pendaftaran/calon_wp/save/";
	GLOBAL_CALON_WP_VARS["view_calon_wp"] = "<?=base_url();?>pendaftaran/calon_wp/view/";
</script>
<script type="text/javascript" src="modules/pendaftaran/scripts/add_calon_wp.js"></script>