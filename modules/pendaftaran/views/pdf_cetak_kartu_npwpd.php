...
if ($wp->wp_wr_gol == '1') {
	...
	$kop[1]['TEXT'] = "NPWPD : " . $nik->wp_wr_nik;
	$kop[1]['T_SIZE'] = 8;$kop[1]['T_TYPE'] = '';$kop[1]['T_ALIGN'] = 'C';$kop[1]['LN_SIZE'] = 5;
...
$ttd[0]['LN_SIZE'] = 5;$ttd[1]['LN_SIZE'] = 5;
$pdf->tbDrawData($ttd);

$ttd[1]['TEXT'] = "<small>" . $pejabat->ref_pangpej_ket . "</small>";
$ttd[0]['LN_SIZE'] = 3;$ttd[1]['LN_SIZE'] = 3;
$pdf->tbDrawData($ttd);
...
$pdf->Image($logo,49,49,30,10);

$logo = "assets/images/stempel_new.jpg";
$pdf->Image($logo,37,48,12,11);
...
$p[0]['TEXT'] = "";
$p[1]['TEXT'] = "1.";
$p[2]['TEXT'] = "Kartu ini harap disimpan baik-baik dan apabila hilang agar segera melaporkan ke Badan Pendapatan Daerah.";
$p[3]['TEXT'] = "";
$p[2]['T_ALIGN'] = 'J';
$pdf->tbDrawData($p);
...
$p[1]['TEXT'] = "3.";
$p[2]['TEXT'] = "Dalam hal wajib pajak pindah domisili, supaya melaporkan ke Badan Pendapatan Daerah Kota Bekasi.";
$pdf->tbDrawdata($p);
