           		...
           		<tr>
                	<td align="RIGHT">
                    	<input type="BUTTON" value="TAMBAH DETAIL" id="btn_add_detail"> &nbsp;&nbsp;&nbsp; TOTAL
                        	&nbsp;&nbsp;&nbsp; 
                            <input type="text" name="totalSetorBank" id="totalSetorBank" class="inputbox" size="20" value="" readonly="true" 
...
<script type="text/javascript" src="modules/bkp/scripts/add_setor_bank.js"></script>
