...
$pdf = new FPDF_TABLE('P','mm','A4'); // Portrait dengan ukuran kertas Letter and width 190 px
$pdf->Open();
$pdf->SetAutoPageBreak(true, 10); 		// Page Break dengan margin bawah 1 cm}
//$pdf->SetAutoPageBreak(true, 65); // Page Break dengan margin bawah 6.5 cm}
...
if (!empty($arr_data)) {
	...
	$dt1[0]['TEXT'] = "";
	$dt1[2]['TEXT'] = "          Nomor : ".$arr_data[0]['skbh_no'];$dt1[2]['ROWSPAN'] = 1;$dt1[2]['V_ALIGN'] = 'T';
	$dt1[1]['COLSPAN'] = 1;$dt1[1]['T_ALIGN'] = 'L';$dt1[1]['T_TYPE'] = '';
	$dt1[2]['T_ALIGN'] = 'L';$dt1[3]['T_SIZE']=9;
	$pdf->tbDrawData($dt1);

	//$dt1[0]['TEXT'] = "";
	//$dt1[2]['TEXT'] = "NTPN : ".$arr_data[0]['ntp'];$dt1[2]['ROWSPAN'] = 2;$dt1[2]['V_ALIGN'] = 'T';
	//$dt1[1]['COLSPAN'] = 1;$dt1[1]['T_ALIGN'] = 'C';$dt1[1]['T_TYPE'] = '';
	//$dt1[2]['T_ALIGN'] = 'L';$dt1[3]['T_SIZE']=9;
	//$pdf->tbDrawData($dt1);
	...
	$dt1[0]['TEXT'] = "Dari       : ".$arr_data[0]['wp_wr_nama'];
	$dt1[0]['COLSPAN']=3;
	$dt1[4]['TEXT'] = "";
	$pdf->tbDrawData($dt1);
	...
	$dt1[0]['TEXT'] = "Alamat   : ".$arr_data[0]['wp_wr_almt'];
	$dt1[0]['COLSPAN']=3;
	$dt1[4]['TEXT'] = "";
	$pdf->tbDrawData($dt1);

	$dt1[0]['TEXT'] = "Wilayah : ".$arr_data[0]['skbh_nama'];
	$dt1[0]['COLSPAN']=3;
	$dt1[4]['TEXT'] = "";
	$pdf->tbDrawData($dt1);

	$dt1[0]['TEXT'] = "Sebagai penyetoran pajak : ".$arr_data[0]['ref_jenparet_ket'];
	$dt1[0]['COLSPAN']=3;
	$dt1[4]['TEXT'] = "";
	$pdf->tbDrawData($dt1);
	
	$dt3[0]['TEXT'] = "";
	$dt3[0]['TEXT'] = "Sebesar : Rp. ".format_currency($arr_data[0]['skbh_jumlah']);
	$dt3[0]['COLSPAN'] = 3;
	$dt3[3]['TEXT'] = "";
	$pdf->tbDrawData($dt3);
...
//	$pdf->MultiCell(190,3,$pdf->SetFont('Arial','',6).$pdf->Cell(15,2,'- Lembar 6 ','','','L').$pdf->Cell(3,2,':','','','C').$pdf->Cell(80,2,'Untuk Bank','','','L'),'','','',2);
	...
	//$logo = "assets/". $pemda->dapemda_logo_path;
	$pdf->Image('assets/images/logo-kotabekasi.jpg',16,13,15,0);
