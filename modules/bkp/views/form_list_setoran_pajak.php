						...
						<table>
							...
							<tr>
								<td class="key">
									Jatuh Tempo</td>
								<td align="left">
									<input type="text" name="txt_jatuh_tempo" id="txt_jatuh_tempo" class="inputbox" size="10" maxlength="10" readonly="true" value="<?= format_tgl($jatuh_tempo); ?>"/>
								</td>
							</tr>							
						</table>
					</td>
								...
								<td>
									<table border=0 cellspacing="1" width="100%">
										...
										<tr>
											...
											<td>
												<input type="text" name="txt_setoran" id="txt_setoran" value="<?= format_currency($total+$denda); ?>" class="inputbox" 
													style="font-weight: bold; text-align: right;" size="17" maxlength="40"  />
											</td>
										</tr>
					...
					<td align="right" colspan="2">
						<table class="admintable" align="right">
							...
							<tr>
								...
								<td align="right">
									<input type="text" name="txt_denda" id="txt_denda" class="inputbox" size="20" maxlength="40"  style="text-align: right;" value="<?= format_currency($denda); ?>"/>
								</td>
							</tr>
							<?php 
							}
