						...
						<table class="adminlist" style="font-size: 12px;" id="detailTable">
	                        ...
	                        ?>
	                        	<tr>
									...
									if ($row->koderek=='4.1.1.08.01' || $row->koderek=='4.1.1.04.01' || $row->koderek=='4.1.1.04.02' || $row->koderek=='4.1.1.04.03' || $row->koderek=='4.1.1.04.04' || $row->koderek=='4.1.1.04.05'
                            ...
                            ?>
                            	<tr>
                            		...
                            		<td align="right">
                            			<input type="text" name="txt_total_setor" id="txt_total_setor" value="<?= format_currency($total_air_reklame); ?>" class="inputbox" 
