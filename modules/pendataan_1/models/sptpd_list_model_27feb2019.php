...
class Sptpd_list_model extends CI_Model {
	...
	function get_list_spt_by_tanggal_entry() {
		...
		/*	  $sql_cari = "SELECT * FROM v_sptpd_list b ";
		...
		*/
		$sql_cari = "SELECT *
				...
				if($spt_jenis_pajak == 2 AND $spt_jenis_pajak_restoran !=0 AND $spt_jenis_pajak_restoran == 1){
					$sql_cari .= " WHERE korek_rincian !='05' ";
					...
					$sql_cari .= " WHERE (korek_rincian ='01' or korek_rincian ='02' or korek_rincian ='05') ";
				}
				$sql_cari .= "  AND spt_id IS NOT NULL";
		}		
