			  		...
			  		<table class="admintable">
						...
						<tr>
							...
							<td>
								...
								if ($this->session->userdata('USER_SPT_CODE') == "10") {
								?>
								<input type="button" name="btn_cetak_xls2" id="btn_cetak_xls2" value=" Cetak Excel " class="button" />
								<?php 
								}
								?>
							</td>
...
<script type="text/javascript">
	...
	GLOBAL_SPTPD_VARS["cetak_xls2"] = "<?=base_url();?>pendataan/sptpd/cetak_xls_daftar_sptpd2";
