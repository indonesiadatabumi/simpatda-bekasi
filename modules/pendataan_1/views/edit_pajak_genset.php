				...
				<td valign="top">
					<table class="admintable" border=0 cellspacing="1">
						...
						<tr>
							...
							<td>
								<input type="text" name="spt_pajak" id="spt_pajak" value="<?= format_currency($row->spt_pajak); ?>" <?= $js;?> class="inputbox" size="15"
						...
						<tr>
							...
							<td>
								...
								?>
			          			<input type="text" name="spt_nilai" id="spt_nilai" value="<?= format_currency($dasar_pengenaan);?>" class="inputbox" size="20"
...
<script type="text/javascript" src="modules/pendataan/scripts/edit_pajak_genset.js"></script>