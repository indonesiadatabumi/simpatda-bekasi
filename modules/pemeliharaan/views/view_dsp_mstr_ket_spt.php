...
<a href="#" onclick="openChildGB('Cetak Daftar Keterangan SPT','<?//= $myself.$XFA['dsp_cetak_mstr_ket_spt'];?>','win2')" style="cursor:pointer" >
...
<a href="#" onclick="javascript:submitbutton('new')" class="toolbar">
<span class="icon-32-new" title="Baru">
</span>
Baru
</a>
</td>
...
<td class="button" id="toolbar-delete">
<a href="#" onclick="javascript:if(document.adminForm.boxchecked.value==0){alert('Tentukan Pilihan Anda Terlebih Dahulu');}else{  submitbutton('remove')}" class="toolbar">
...
<div class="header icon-48-master"> KETERANGAN SPT </div>
<div class="clr"></div>
			</div>
			<div class="b">
				<div class="b">
		...
		<div id="element-box">
			...
			<div class="m">
<form name="adminForm" action="<?php //echo $myself.$XFA['act_mstr_ket_spt']; ?>" method="post">
...
<!--END OF FLEXIGRID-->
		...
		<input type="hidden" name="bca500dec7e618674e233206add340e6" value="1" />		</form>
