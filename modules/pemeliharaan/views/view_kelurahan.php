...
<script type="text/javascript">
	var GLOBAL_KELURAHAN_VARS = new Array();
	GLOBAL_KELURAHAN_VARS["get_list"] = "<?=base_url();?>pemeliharaan/kelurahan/get_list";
	GLOBAL_KELURAHAN_VARS["add"] = "pemeliharaan/kelurahan/add";
	GLOBAL_KELURAHAN_VARS["edit"] = "pemeliharaan/kelurahan/edit";
	GLOBAL_KELURAHAN_VARS["delete"] = "<?=base_url();?>pemeliharaan/kelurahan/delete";
</script>
<script type="text/javascript" src="modules/pemeliharaan/scripts/view_kelurahan.js"></script>
