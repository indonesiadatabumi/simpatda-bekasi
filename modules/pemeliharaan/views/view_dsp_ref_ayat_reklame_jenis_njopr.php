...
Ayat Jenis NJOPR
	...
	<span id="afterKonfirm" style="display:none;"></span>
<form action="<?//= $myself.$XFA['act_ref_ayat_reklame_jenis_njopr']; ?>" method="post" name="adminForm">
<table id="flex1" style="display:none"></table>

<span id="saveBar"></span>

		<input type="hidden" name="id_konfirm" value="0" />
		...
		<input type="hidden" name="which" value="header" />
