...
<td class="button" id="toolbar-StatusAnggaran">
<a href="#"
onclick="openChildGB('Status Anggaran','<?//= $myself.$XFA['dsp_mstr_status_anggaran'];?>','win2')" style="cursor:pointer" >
<span class="icon-32-ref" title="StatusAnggaran">
</span>
Status Anggaran
</a>
</td>
...
Tabel Tahun Anggaran</div>
		...
		<div id="element-box">
			...
			<div class="m">
<form action="<?//php echo $myself.$XFA['act_mstr_tahun_anggaran']; ?>" method="post" name="adminForm">
