...
<script type="text/javascript">
	var GLOBAL_UPTD_VARS = new Array();
	GLOBAL_UPTD_VARS["get_list"] = "<?=base_url();?>pemeliharaan/uptd/get_list";
	GLOBAL_UPTD_VARS["add"] = "pemeliharaan/uptd/add";
	GLOBAL_UPTD_VARS["edit"] = "pemeliharaan/uptd/edit";
	GLOBAL_UPTD_VARS["delete"] = "<?=base_url();?>pemeliharaan/uptd/delete";
</script>
<script type="text/javascript" src="modules/pemeliharaan/scripts/view_uptd.js"></script>
