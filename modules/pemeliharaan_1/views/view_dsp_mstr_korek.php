...
<a href="#" onclick="openChildGB('Cetak Daftar Kode Rekening','<?//= $myself.$XFA['dsp_cetak_mstr_korek'];?>','win2')" class="toolbar">
...
Tabel Kode Rekening
		...
		<div id="element-box">
			...
			<div class="m">
<form action="<?php //echo $myself.$XFA['act_mstr_korek']; ?>" method="post" name="adminForm">
