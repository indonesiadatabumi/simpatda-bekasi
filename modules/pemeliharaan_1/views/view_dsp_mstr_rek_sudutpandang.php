...
<div class="header icon-48-master"> Sudut Pandang dan Kelas Jalan </div>
		...
		<div id="element-box">
			...
			<div class="m">
<form action="<?//= $myself.$XFA['act_mstr_rek_sudutpandang']; ?>" method="post" name="adminForm">
...
<div id="formSelect_klasjalan" style="display:none;"></div>
