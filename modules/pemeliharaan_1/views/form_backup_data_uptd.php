...
<script type="text/javascript">
	...
	GLOBAL_BACKUP_DATA_VARS["view"] = "<?=base_url();?>pemeliharaan/backup_data_uptd/view";
	GLOBAL_BACKUP_DATA_VARS["export"] = "<?=base_url();?>pemeliharaan/backup_data_uptd/export";
</script>
<script type="text/javascript" src="modules/pemeliharaan/scripts/form_backup_data_uptd.js"></script>