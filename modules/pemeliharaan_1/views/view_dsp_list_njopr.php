...
Table Perhitungan Nilai Jual Objek Pajak Reklame
		...
		<div id="element-box">
			...
			<div class="m">
<form action="<?php //echo $myself.$XFA['act_form_njopr']; ?>" method="post" name="adminForm">
<table id="flex1" style="display:none"></table>

<span id="saveBar"></span>		

		<input type="hidden" name="idhead" value="<?//=$v_det[ref_jr_head]?>" />
