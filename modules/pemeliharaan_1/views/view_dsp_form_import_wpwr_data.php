		...
		<div class="padding">
			...
			<div id="element-box">
				...
				<div class="m">
					<!-- content body -->
					<fieldset>
						<legend>Import data WP/WR per kecamatan dan kelurahan</legend>
					<form action="<?php //echo $myself.$XFA['act_form_import_wpwr_data']; ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm">
					<?php
					...
					?>
					<p><strong>Download template Excel</strong> : <a href="su/readexcel/templatedatawp.xls">templatedatawp.xls</a></p>
