...
<a href="#" onclick="openChildGB('Cetak Daftar Kode Usaha','<?//= $myself.$XFA['dsp_cetak_mstr_usaha'];?>','win2')" style="cursor:pointer" >
...
<a href="#" onclick="javascript:if(document.adminForm.boxchecked.value==0){alert('Mohon pilih minimal satu dari list');}else{ hideMainMenu(); submitbutton('edit')}" class="toolbar">
...
<td class="button" id="toolbar-delete">
<a href="#" onclick="javascript:if(document.adminForm.boxchecked.value==0){alert('Mohon pilih minimal satu dari list');}else{  konfirm('remove')}" class="toolbar">
...
<form action="<?//= $myself.$XFA['act_mstr_usaha']; ?>" method="post" name="adminForm">
