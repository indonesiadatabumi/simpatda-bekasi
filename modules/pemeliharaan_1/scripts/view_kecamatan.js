...
var createDataGrid = function (){
	$("#tbl_kecamatan").flexigrid({
		url: GLOBAL_KECAMATAN_VARS["get_list"],
		dataType: 'json',
		colModel : [
 ...
 * @returns
 */
var editKecamatan = function(id) {
	showDialogPost(GLOBAL_KECAMATAN_VARS["edit"], "Kecamatan", {camat_id : id}, 700, 300);
};
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		showDialog(GLOBAL_KECAMATAN_VARS["add"], "Kecamatan", 700, 300);
 	});
 	...
 	$("#btn_status_anggaran").click(function() {
 		showDialog(GLOBAL_KECAMATAN_VARS["form_status_anggaran"], 'Status Anggaran', 950, 550);
 	});
 };
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_KECAMATAN_VARS["delete"],
