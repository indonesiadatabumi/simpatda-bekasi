...
var createDataGrid = function (){
	$("#pajak_pln_table").flexigrid({
		url: GLOBAL_PAJAK_PLN_VARS["get_list"],
		dataType: 'json',
		colModel : [
		...
		sortorder: "desc",
		usepager: true,
		title: 'DAFTAR SPT PENERANGAN JALAN PLN',
		useRp: true,
		rp: 10,
...
var editData = function(spt_id, spt_jenis_pajakretribusi) {
	showDialogPost(GLOBAL_PAJAK_PLN_VARS["edit_sptpd"], "Pajak PLN", {
				'spt_id' : spt_id,
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PAJAK_PLN_VARS["add_sptpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_MAIN_VARS["BASE_URL"] + "pendataan/pajak_pln/delete",
