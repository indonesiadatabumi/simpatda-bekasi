...
var load_ads_assess_panel = function(row_number){
	...
	var no_rekening = spt_dt_korek.text().substring(1, 12); 
	var area_1 =$("input[name=area1"+row_number+"]:checked");
	...
	//	if (spt_dt_korek =="1")
	//	{$("#spt_dt_persen_tarif"+row_number).val("25");}
	//	else {$("#spt_dt_pe rsen_tarif"+row_number).val("50");}
		...
		rowField = 
			'<table><tr>'+
				...
				'<tr>'+
					...
					'<td><input type="text" name="spt_dt_persen_tarif'+row_number+'" id="spt_dt_persen_tarif'+row_number+'" class="inputbox" size="2" value=""   style="text-align:right;"/> %</td>' +
				'</tr>' +
				'<tr>'+
