...
var createDataGrid = function (){
	$("#pajak_genset_table").flexigrid({
		url: GLOBAL_PAJAK_GENSET_VARS["get_list"],
		dataType: 'json',
		colModel : [
...
var editData = function(spt_id, spt_jenis_pajakretribusi) {
	showDialogPost(GLOBAL_PAJAK_GENSET_VARS["edit_sptpd"], "Pajak Genset", {
				'spt_id' : spt_id,
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PAJAK_GENSET_VARS["add_sptpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_MAIN_VARS["BASE_URL"] + "pendataan/pajak_genset/delete",
