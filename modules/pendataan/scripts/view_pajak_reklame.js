...
var createDataGrid = function (){
	$("#pajak_reklame_table").flexigrid({
		url: GLOBAL_PAJAK_REKLAME_VARS["get_list"],
		dataType: 'json',
		colModel : [
			...
			{display: 'NPWPD / NPWRD', name : 'npwprd', width : 120, sortable : true, align: 'center',process: cellClick, hide: true},
			{display: 'Nama WP', name : 'wp_wr_nama', width : 160, sortable : true, align: 'left', process: cellClick},
			{display: 'Alamat WP', name : 'wp_wr_almt', width : 220, sortable : true, align: 'left', process: cellClick},
...
var editData = function(spt_id, spt_jenis_pajakretribusi) {
	showDialogPost(GLOBAL_PAJAK_REKLAME_VARS["edit_sptpd"], "Pajak Reklame", {
				'spt_id' : spt_id,
 ...
 var createEventToolbar = function (){	 	
 	$("#btn_add").click(function (){
 		// load content
 		load_content(GLOBAL_PAJAK_REKLAME_VARS["add_sptpd"]);
 	});
 ...
 var deleteData = function() {
	 var remove = function (){
		 ...
		 $.ajax({
		     type: "POST",
		     url: GLOBAL_MAIN_VARS["BASE_URL"] + "pendataan/pajak_reklame/delete",
