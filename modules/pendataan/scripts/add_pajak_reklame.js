...
var completePage = function() {
	...
	$('#btn_search').click(function() {
		showDialog("wajib_pajak/get_data_reklame/" + $("input[name=kodus_id]").val(), 'Daftar Pelayanan Reklame', 1000, 500);
	...
	if (no_rekening == "4.1.1.04.01" || no_rekening == "4.1.1.04.02" || no_rekening == "4.1.1.04.12") {
		...
		rowField = 
			'<table>'+
				...
				'</tr>' +
			'</table>';
	} else if (no_rekening == "4.1.1.04.06"|| no_rekening == "4.1.1.04.07") {
		rowField = 
			'<table>'+
