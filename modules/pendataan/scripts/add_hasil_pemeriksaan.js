...
var calcPengenaan = function(n) {
	...
	pengenaan = Math.round((100/persen_tarif) * $('#pajak_terhutang'+n).val());
...
var calcTerhutang = function(n) {
	...
	$('#pajak_terhutang'+n).val(Math.round(unformatCurrency($('#lhp_dt_dsr_pengenaan'+n).val()) * persen_tarif / 100));
...
var calcPokokPajak = function(n) {
	$('#pokok_pajak'+n).val(Math.round(unformatCurrency($('#pajak_terhutang'+n).val()) * 1 - unformatCurrency($('#kredit_pajak'+n).val()) * 1));
