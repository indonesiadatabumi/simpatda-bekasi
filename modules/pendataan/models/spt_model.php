...
class Spt_model extends CI_Model {
	...
	function cek_data_detil_resto($spt_id) {
		$sql = "SELECT COUNT(spt_dt_id_spt) AS spt_dt_id_spt FROM spt_detail WHERE spt_dt_id_spt='$spt_id'";
		$query = $this->db->query($sql);
		
		return $query->row();
	}

	function get_data_spt($spt_id) {
		
		$sql = "SELECT * FROM spt WHERE spt_id = $spt_id";
		// echo $sql;die;
		$query = $this->db->query($sql);
	...
	function history_del_spt($data_spt) {
		$data = array(
				'spt_id' => $data_spt->spt_id,
				'spt_periode' => $data_spt->spt_periode,
				'spt_nomor' => $data_spt->spt_nomor,
				'spt_kode_rek' => $data_spt->spt_kode_rek,
				'spt_tgl_terima' => $data_spt->spt_tgl_terima,
				'spt_tgl_bts_kembali' => $data_spt->spt_tgl_bts_kembali,
				'spt_nama_penerima' => $data_spt->spt_nama_penerima,
				'spt_alamat_penerima' => $data_spt->spt_alamat_penerima,
				'spt_periode_jual1' => $data_spt->spt_periode_jual1,
				'spt_periode_jual2' => $data_spt->spt_periode_jual2,
				'spt_status' => $data_spt->spt_status,
				'spt_nilai' => $data_spt->spt_nilai,
				'spt_pajak' => $data_spt->spt_pajak,
				'spt_operator' => $data_spt->spt_operator,
				'spt_jenis_pajakretribusi' => $data_spt->spt_jenis_pajakretribusi,
				'spt_idwpwr' => $data_spt->spt_idwpwr,
				'spt_jenis_pemungutan' => $data_spt->spt_jenis_pemungutan,
				'spt_tgl_proses' => $data_spt->spt_tgl_proses,
				'spt_tgl_entry' => $data_spt->spt_tgl_entry,
				'spt_tarif_persen' => $data_spt->spt_tarif_persen,
				'spt_tarif_dasar' => $data_spt->spt_tarif_dasar,
				'spt_no_register' => $data_spt->spt_no_register,
				'spt_idwpwr_detail' => $data_spt->spt_idwpwr_detail,
				'spt_kode' => $data_spt->spt_kode,
				'spt_idwp_reklame' => $data_spt->spt_idwp_reklame,
				'spt_kode_billing' => $data_spt->spt_kode_billing,
				'status_bayar' => $data_spt->status_bayar,
