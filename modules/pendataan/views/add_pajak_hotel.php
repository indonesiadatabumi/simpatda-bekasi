				...
				<tr>
					...
					<table class="admintable">
						...
						<td class="key">
								Tanggal Proses</td>
							<td>
								<input type="text" name="spt_tgl_proses" id="spt_tgl_proses" class="mandatory" size="11" value="<?= date("d-m-Y")?>"  />
							</td>
						</tr>
						<tr>
							<td class="key">Tanggal Entry</td>
							<td>
								<input type="text" name="spt_tgl_entry" id="spt_tgl_entry" class="mandatory" size="11" value="<?= date("d-m-Y")?>"  />
							</td>
						</tr>
						<tr>
							<td class="key">
				...
				<td valign="top">
					<table class="admintable" border=0 cellspacing="1">
						...
						<tr>
							...
							<td>
			          			<input type="text" name="spt_nilai" id="spt_nilai" class="inputbox" size="25" <?= $js;?> onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');"
...
<script type="text/javascript" src="modules/pendataan/scripts/add_pajak_hotel.js"></script>