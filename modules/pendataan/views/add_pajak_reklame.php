				...
				<tr>
						...
						<table class="admintable">
							...
							<tr>
								...
								<td>
									...
									<!-- <input type="text" name="spt_periode" id="spt_periode" class="inputbox" size="4" maxlength="4" /> -->
					...
					<td valign="top">
						<table class="admintable" border=0 cellspacing="1">
							<tr>
								<td></td>
								<td><input type="button" id="btn_search" size="2" value="Cari Data" class="button"></td>
							</tr>
							<tr>
								<td class="key">
