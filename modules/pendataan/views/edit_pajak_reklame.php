									...
									foreach ($rows_detail as $row_detail) {
										...
										echo "</select>
													...
													<tr>
														...
														<td>
															<select name='txt_kode_camat' id='txt_kode_camat' class='inputbox'>";
															if ($row->camat_id == null){
																echo "<option value='' selected>--</option>";
															}else{
																echo "<option value='".$row->camat_id."' selected>".$row->camat_kode . ' | ' . $row->wp_wr_camat."</option>";
															}
																
															foreach ($kecamatan as $camat){
																echo "<option value='".$camat->camat_id."'>".$camat->camat_kode . ' | ' . $camat->camat_nama."</option>";
															}
													echo "</select>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<select name='txt_kode_lurah' id='txt_kode_lurah' class='inputbox'>";
															if ($row->lurah_id == null){
																echo "<option value='' selected>--</option>";
															}else{
																echo "<option value='".$row->lurah_id."' selected>".$row->lurah_kode . ' | ' . $row->wp_wr_lurah."</option>";
															}
