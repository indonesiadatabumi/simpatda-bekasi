						 ...
						 <tr>
							...
							<td>
								<select name="ddl_daftar" id="ddl_daftar">
									<option value="1">SPT yang sudah disampaikan</option>
									<option value="2">SPT yang belum disampaikan</option>
									<option value="0">SPT yang sudah dan belum disampaikan</option>
								</select>
							</td>
						</tr>
						<tr>
