					...
					<table class="admintable">
						<tr>
							...
							<td>
								...
								<input type="text" name="spt_no_register" id="spt_no_register" class="inputbox mandatory" <?= $js; ?> size="10" maxlength="5" readonly="readonly"/> 
...
<script type="text/javascript" src="modules/pendataan/scripts/add_pajak_restoran.js"></script>