<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-pendaftaran_bu">
			Rekam Formulir Pendaftaran: <small><small id='title_head'>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
		...
		<form name="frm_rekam_formulir" id="frm_rekam_formulir">
			...
			<table class="admintable" border=0 cellspacing="1">
				<tr>
					...
					<td>
						<input type="text" size="10" maxlength="8" class="mandatory" readonly="readonly" id="txt_no_formulir" name="txt_no_formulir" value="<?= $row->form_nomor; ?>" />
					</td>
				</tr>
				<tr>
					<td class="key"><label for="nama_wp">Nama</label></td>
					<td>
						<input style="text-transform: uppercase;" type="text" name="txt_nama" id="txt_nama" class="inputbox mandatory" size="40" value="<?= $row->form_nama; ?>" />
					</td>
				</tr>
				<tr>
					<td class="key" valign="top"><label for="alamat">Alamat</label></td>
					<td>
						<textarea style="text-transform: uppercase;" cols="40" rows=2 name="txt_alamat" id="txt_alamat" class="inputbox mandatory"><?= $row->form_alamat; ?></textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="key">Tanggal Pengiriman</td>
					<td>
						<input type="text" name="txt_tgl_kirim" id="txt_tgl_kirim" size="10" value="<?= format_tgl($row->form_tgl_kirim); ?>" class="mandatory" />
					</td>
				</tr>
				<tr>
...
<script type="text/javascript" src="modules/pendaftaran/scripts/edit_rekam_formulir.js"></script>