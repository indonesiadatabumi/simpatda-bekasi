			...
			<td colspan="2">
				<table cellspacing="1" style="border-collapse: collapse;">
					...
					<tr>
						<td></td>
						<td>
							<div style="position: absolute; top: 40mm; left: 50mm;">
								<img style="WIDTH:105px; HEIGHT:25px;" opacity="0.9" src="assets/images/ttd_kadis.bmp">
							</div>														
						</td>
					</tr>
					<tr>
...
$html2 = "<br/><table style='margin-top: 15; font-family:Arial, Verdana; padding: 0; font-size: 10;font-weight:bold;width:300;text-align:justify;' >
			...
			<tr>
				...
				<td width='5'></td>
				<td>
					Kartu ini hendaknya dibawa apabila saudara akan membayar pajak, melakukan transaksi dan berhubungan dengan instansi-instanse
				</td>
			</tr>
			<tr>
				<td valign='top'>3.</td>
