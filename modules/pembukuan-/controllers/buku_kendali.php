<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ini_set("memory_limit", "8000M");
...
class Buku_kendali extends Master_Controller {
	...
	function cetak_kendali() {
		...
		if ($spt_ket==3){$sptkk='STPD';}
		else if ($spt_ket==1){$sptkk='SKPD';}
		else if ($spt_ket==2){$sptkk='SKPDT';}
		else if ($spt_ket==4){$sptkk='STRD';}
		else if ($spt_ket==5){$sptkk='SKRD, JAB';}
		else if ($spt_ket==8){$sptkk='SPTPD';}
		else if ($spt_ket==9){$sptkk='SKRD';}
		else if ($spt_ket==11){$sptkk='SKPDKB';}
		else if ($spt_ket==12){$sptkk='SKPDLB';}			
		else if ($spt_ket==14){$sptkk='SKPDN';}
		else if ($spt_ket==15){$sptkk='SKPDKBT';}
		...
		$no_baris = 3;
		$dt_penerimaan = $this->buku_kendali_model->get_data_pajak($this->input->get('jenis_pajak_kendali'), 
