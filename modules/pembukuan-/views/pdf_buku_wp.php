...
if (!empty($dt_rows)) {
    ...
    $pdf->Cell(45,5,"U R A I A N",1,0,'C');
	$pdf->Cell(60,5,"MASA PAJAK",1,0,'C');
    ...
    $pdf->Cell(7,1,"",'LR',0,'C').$pdf->Cell(28,1,"",'R',0,'C').$pdf->Cell(45,1,"",'R',0,'C').$pdf->Cell(60,1,"",'R',0,'C').$pdf->Cell(17,1,"",'R',0,'C').$pdf->Cell(17,1,"",'R',0,'C').$pdf->Cell(28,1,"",'R',0,'C').$pdf->Cell(28,1,"",'R',0,'C').$pdf->Cell(17,1,"",'R',0,'C').$pdf->Cell(17,1,"",'R',0,'C').$pdf->Cell(28,1,"",'R',0,'C').$pdf->Cell(28,1,"",'R',2,'C');
    $pdf->Ln(0);
    $total_tetap = 0;
    $total_setor = 0;
    $total_sisa = 0;
	...
	if($_GET['jenis_pemungutan'] == 2) {
        	...
        	$pdf->MultiCell(310, 5, $pdf->Cell(7,5,$counter,'LR',0,'L').
        							...
        							$pdf->Cell(45,5,$vw['korek_nama'],'R',0,'L').
									$pdf->Cell(60,5,format_tgl($vw['spt_periode_jual1'])."  s.d  ".format_tgl($vw['spt_periode_jual2']),'R',0,'C').
