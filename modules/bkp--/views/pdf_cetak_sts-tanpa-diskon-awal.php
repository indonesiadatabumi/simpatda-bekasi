...
if (!empty($arr_data)) {
	...
	if (substr($val['koderek'],0,8)=='4.1.1.08' || substr($val['koderek'],0,8)=='4.1.1.04'){
	...
	$data3[1]['TEXT'] = "";
	$data3[3]['TEXT'] = "Jumlah : ";
	/*if ($val['koderek']=='4.1.1.08.01' || $val['koderek']=='4.1.1.04.01' || $val['koderek']=='4.1.1.04.02' || $val['koderek']=='4.1.1.04.03' || $val['koderek']=='4.1.1.04.04' 
	|| $val['koderek']=='4.1.1.04.05' || $val['koderek']=='4.1.1.04.06' || $val['koderek']=='4.1.1.04.07' || $val['koderek']=='4.1.1.04.08' || $val['koderek']=='4.1.1.04.09'
	|| $val['koderek']=='4.1.1.04.10' || $val['koderek']=='4.1.1.04.12'){*/
		if (substr($val['koderek'],0,8)=='4.1.1.08' || substr($val['koderek'],0,8)=='4.1.1.04'){
